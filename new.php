<?php include ('header.php'); ?>
      ...
      <div class="container text-center py-5" style="max-width: 900px">
        ...
        >
          <li class="breadcrumb-item">
            <a href="index.html" class="text-white">11th Feb 2024</a>
          </li>
          <!-- <li class="breadcrumb-item">
            <a href="#" class="text-white"></a>
          </li> -->
          <li class="breadcrumb-item active text-secondary">Abu Dhabi</li>
        </ol>
      </div>
    </div>
    <!-- Header End -->
    ...
    <div class="row g-3">
        <div class="col-12 mb-3">
            <input type="text" class="form-control filter-input" placeholder="Search services..." aria-label="Search Services">
        </div>
        <div class="col-md-4">
            <select class="form-select filter-select" aria-label="Filter by Region">
        ...
        <div class="col-md-4">
            <select class="form-select filter-select" aria-label="Filter by Industry">
        ...
        <div class="col-md-4">
            <input type="date" class="form-control filter-input" aria-label="Filter by Date">
        </div>
    </div>
</div> -->
    ...
    <div class="container-fluid training bg-light overflow-hidden py-5">
      <div class="container py-5">
        ...
        >
          <div class="sub-style">
            <h5 class="sub-title text-primary px-3">About the Event</h5>
          </div>

          <!-- <h1 class="display-5 mb-4">
            Stay Connected with the Latest in Franchising
          </h1> -->
          <p class="mb-0">
            ...
            <div class="training-item">
              <div class="training-inner">
                ...
                <div class="training-title-name">
                  <a href="#" class="h4 text-white mb-0">Population</a>
                </div>
              </div>
              <div class="training-content bg-secondary rounded-bottom p-4">
                <a href="#"
                  ><h4 class="text-white">Population</h4></a
                >
                <p class="text-white-50">
                  Approximately 10 million, comprising a diverse and affluent consumer base
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div class="training-item">
              <div class="training-inner">
                ...
                />
                <div class="training-title-name">
                  <a href="#" class="h4 text-white mb-0">Franchise Trends</a>
                </div>
              </div>
              <div class="training-content bg-secondary rounded-bottom p-4">
                <a href="#"
                ...
                >
                <p class="text-white-50">
                  High demand for food and beverage, premium retail, wellness, and tech-driven franchises.
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="training-inner">
                ...
                <div class="training-title-name">
                  <a href="#" class="h4 text-white mb-0"
                    >Franchise Innovation</a
                  >
                  <a href="#" class="h4 text-white mb-0">Forum</a>
                </div>
              </div>
              <div class="training-content bg-secondary rounded-bottom p-4">
                <a href="#"
                  ><h4 class="text-white">Franchise Innovation Forum</h4></a
                >
                <p class="text-white-50">
                  Explore cutting-edge technologies and innovative practices
                  driving success in the franchising world at this tech-focused
                  event.
                </p>
                <a
          ...
          >
            <div class="training-item">
              <div class="training-inner">
                ...
                />
                <div class="training-title-name">
                  <a href="#" class="h4 text-white mb-0">Emerging Markets</a>
                  <a href="#" class="h4 text-white mb-0">Focus Meet</a>
                </div>
              </div>
              <div class="training-content bg-secondary rounded-bottom p-4">
                <a href="#"
                  ><h4 class="text-white">Emerging Markets Focus Meet</h4></a
                >
                <p class="text-white-50">
                  A must-attend event for businesses looking to tap into the
                  immense potential of emerging markets like India, Southeast
      ...
      <div class="container">
        <div class="text-center">
          <h1 class="display-6 mb-4" style="color: white">
            UAE: A Booming Hub for Franchise Opportunities
          </h1>
        </div>
        ...
        <div class="stats-grid">
          ...
          <div class="stat-item">
            <h4 class="text-white">Franchise Trends</h4>
            <p>
                High demand for food and beverage, premium retail, wellness, and tech-driven franchises.
            </p>
          </div>
          <div class="stat-item">
            <h4 class="text-white">Strategic Importance</h4>
            <p>
                Abu Dhabi stands as the political, cultural, and industrial hub of the UAE, with a fast-growing economy.
            </p>
          </div>
          <div class="stat-item">
            <h4 class="text-white">HNIs & Investors</h4>
            <p>
              Access exclusive, high-growth franchise opportunities in emerging
              regions.
            </p>
          </div>
          <div class="stat-item">
            <h4 class="text-white">Retailers & Brand Managers</h4>
            <p>
              Learn growth strategies to position your brand for success in new
              markets.
            </p>
          </div>
          <div class="stat-item">
            <h4 class="text-white">Consultants & Industry Experts</h4>
            <p>
              Showcase expertise, connect with brands, and unlock new advisory
              opportunities.
            </p>
          </div>
        </div>
    ...
    <!-- <div class="container-fluid py-5">
      <div class="container">
        ...
        >
          <div>
            <h3 class="text-primary px-3">Upcoming Events</h3>
          </div>
          <h1 class="display-5 mb-4">
            Explore Our Exclusive Franchise Events.
          </h1>
          <p class="mb-0">
        ...
        <div class="owl-carousel services-slider">
          <div class="card service-card">
            <img src="img/service-1.jpg" class="card-img-top" alt="Service" />
            <div class="card-body">
    ...
    <div class="container-fluid py-5">
      <div class="container">
        ...
        >
          ...
          <h1 class="display-5">Explore Our Moments</h1>
          <p>
    ...
    <!-- Image Gallery End -->
    <!-- cta2 start-->
    <div class="cta-banner" style="background-color: #00142d">
      <div class="container">
        <div class="row align-items-center">
          <!-- Text Content -->
          <div class="col-md-8">
            <h2 class="cta-heading">Start Your Franchising Journey Today!</h2>
            <p class="cta-description">
              Ready to take your business global? Partner with GFF and unlock
              new opportunities in emerging markets. Whether you're looking to
              expand locally or internationally, we provide the expertise and
              support you need to succeed. Let’s turn your franchise vision into
              reality – start today!
            </p>
          </div>
          <!-- Button -->
    ...
    <div class="container-fluid features overflow-hidden py-5">
      <div class="container">
        ...
        >
          <div class="sub-style">
            <h5 class="sub-title text-primary px-3">Why Attend?</h5>
          </div>
        ...
        <div class="row g-4 justify-content-center text-center">
          ...
          >
            <div class="feature-item text-center p-4">
              ...
              <div class="feature-content d-flex flex-column">
                <h5 class="mb-3">Affordable Franchise Setup</h5>
                <p class="mb-3">
          ...
          >
            <div class="feature-item text-center p-4">
              ...
              <div class="feature-content d-flex flex-column">
                <h5 class="mb-3">Franchise Legal Compliance Support</h5>
                <p class="mb-3">
                  Dolor, sit amet consectetur adipisicing elit. Soluta inventore
                  cum accusamus,
                </p>
          ...
          >
            <div class="feature-item text-center p-4">
              ...
              <div class="feature-content d-flex flex-column">
                <h5 class="mb-3">Expedited Franchise Launch</h5>
                <p class="mb-3">
                  Dolor, sit amet consectetur adipisicing elit. Soluta inventore
                  cum accusamus,
                </p>
          ...
          >
            <div class="feature-item text-center p-4">
              ...
              <div class="feature-content d-flex flex-column">
                <h5 class="mb-3">Personalized Franchise Strategy Sessions</h5>
                <p class="mb-3">
                  Dolor, sit amet consectetur adipisicing elit. Soluta inventore
                  cum accusamus,
                </p>
    ...
    <div class="container-fluid country overflow-hidden py-5">
      <div class="container py-5">
        ...
        >
          ...
          <h1 class="display-5 mb-4">Franchise Expansion Services</h1>
          <p class="mb-0">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat
            deleniti amet at atque sequi quibusdam cumque itaque repudiandae
            temporibus, eius nam mollitia voluptas maxime veniam necessitatibus
